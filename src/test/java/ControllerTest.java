...
import com.huan.ted.account.controllers.RoleController;
...
@ContextConfiguration(locations = {"classpath:/spring/test/applicationContext.xml","classpath:/spring/test/applicationContext-*.xml","classpath:/spring/appServlet/servlet-context.xml"})
@Transactional
@Rollback
